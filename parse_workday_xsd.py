...
Usage:
    python parse_workday_xsd.py [--xsd metadata_dict/hr_wd.xml] [--dry-run]
...
def main() -> None:
    ...
    p.add_argument("--xsd", default="metadata_dict/hr_wd.xml")
    p.add_argument("--out", default="metadata_dict/wd_hr_knowledge_overlay.csv")
